...
//==============================2周目=========================			
		...
		name: 				'太空殖民',
		image: 				'locations/t6n1.png',
		description: 		'2周目全新开始图，建造了殖民舰队后重置然后，先领取物资回来开这个地点。【2周目不需要重置】',
		cost:{},		
		requires:{},	
		required_items:{
			物资: 	true,	
		...
		t7n2:{
		name: 				'研究站',
		image: 				'locations/t7n2.png',
		description: 		'2周目全新开始图。注意先别选这个！【先开太空殖民卖点东西到100M后开这个位置选择一次合成金属物资包，大空界面内容就解锁了。】',
		cost:{
		},
		requires:{
